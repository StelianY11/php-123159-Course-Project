...
<body>
    ...
    <header>
        <nav class="navbar navbar-expand-lg navbar-dark bg-light-brown py-3">
            <div class="container-fluid">
                <a class="navbar-brand fw-bold" href="?page=home">Книги</a>
                ...
                <div class="collapse navbar-collapse justify-content-between" id="navbarNav">
                    <ul class="navbar-nav nav-list">
                        <li class="nav-item">
                            <a class="nav-link <?php echo ($page == 'home' ? 'active' : ''); ?>" href="?page=home">Начало</a>
                        </li>
                        <li class="nav-item">
                    ...
                    <div class="d-flex flex-row gap-3">
                        ...
                        if (isset($_SESSION['user_name'])) {
                            echo '<span class="text-dark">Здравейте, ' . htmlspecialchars($_SESSION['user_name']) . '</span>';
                            echo '
    ...
    <footer class="bg-light-brown text-center py-5 mt-auto">
        <div class="container">
            <span class="text-dark">PHP Project Steliyan Yanakeiv 123159</span>
        </div>
    </footer>
